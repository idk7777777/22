...
TAMPER = 'space2comment,between,randomcase' # safedog,doublekeywords,school,0day,randombackspace,doubleurlencode   space2comment,randomcase,between,unmagicquotes,space2plus
